...
## 1. Craftplan — Production Management for Micro-Bakeries & Small-Batch Manufacturers
- **Source**: https://news.ycombinator.com/item?id=46847690
- **Additional Links**: None
- **Platform**: HN
- **Type**: Show HN
- **Engagement**: 577 upvotes, 167 comments (extremely high for a niche tool)
- **Revenue Data**: Open source, no revenue — but massive validation signal
- **Boring Business Score**: 5/5
- **Target Industry**: Small-batch food manufacturing (bakeries, food producers, artisan manufacturers)
- **Core Value Prop**: Built by a developer for his wife's micro-bakery. Handles recipes (versioned BOMs with cost rollups), inventory (lot traceability, demand forecasting, allergen tracking), orders, production batch planning, and purchasing. Replaces spreadsheets and manual tracking.
- **Gap/Opportunity**: 577 upvotes proves the problem resonates hard. It's open-source with no commercial model. Small food producers are a massive, underserved market — cottage food businesses, micro-bakeries, small catering operations, craft food producers all need this but existing production management tools are built for factories. The HN comments (167!) indicate many people in this space or adjacent spaces immediately see the value.
- **Our Angle**: Commercial SaaS version of Craftplan targeting micro-bakeries, cottage food businesses, small catering companies, and artisan food producers. Add: online ordering integration, compliance/licensing tracking (cottage food laws vary by state), customer management, and delivery scheduling. Mobile-first for kitchen use. Price at $29-49/mo — far cheaper than enterprise production management.
- **LTD Potential**: 5/5 — Food producers would pay $99-149 LTD. The category is deeply underserved and the HN validation is extraordinary.
...
- **Platform**: HN
- **Type**: Show HN
- **Engagement**: 2 upvotes, 1 comment
- **Revenue Data**: None — free tool, early stage
- **Boring Business Score**: 5/5
