...
| 2026-05-22 | 82/105 | hn-indiehackers-2026-05-22 | Stable: SINGLE-source — HN/IH: YC Spring 2026 RFS reconfirmed from new source (superframeworks.com YC RFS analysis) — "AI-guided physical work" as priority category; "field techs are massively underserved by tech — almost non-existent competition compared to building another PM tool"; confirmed strategy: single-vertical focus (HVAC only), integrate with existing FSM software (ServiceTitan/Jobber) via webhook, offline-first mobile (basements/attics without signal), build equipment fault knowledge base from real tech photos = data moat; $99/mo per tech willingness to pay confirmed; supply houses + trade associations (ACCA/PHCC) as distribution channels; Sources: superframeworks.com/articles/yc-rfs-startup-ideas-indie-hackers-2026, ycombinator.com/rfs |
| 2026-05-26 | 82/105 | hn-indiehackers-2026-05-26 | Stable: SINGLE-source — HN/IH: Same HN pest control thread (item #47509571, 1,100+ comments) surfaces the specific product builder — a boat captain building a video/photo-first AI agent for marine mechanics; grounded in actual equipment manuals and service data; 16 months in development; "multiple clients"; long-term vision: agent platform for traditional industries bridging knowledge work and physical work; the model: technician photographs broken equipment → AI identifies issue + retrieves relevant service manual section → suggests parts → provides repair steps + links to supplier; no HVAC-specific version exists; start with HVAC (largest volume, most standard manuals, YC RFS explicit priority) + sell through supply houses + ACCA trade associations; $29/mo per technician; data moat = equipment manual corpus per vertical; Sources: news.ycombinator.com/item?id=47509571, ycombinator.com/rfs |
| 2026-06-17 | 82/105 | hn-indiehackers-2026-06-17 | Stable: SINGLE-source — HN: same thread (item #47509571) — product builder confirmed: "my long-term vision is to be the agent platform for traditional industries, bridging the gap between knowledge work and physical work"; video/photo-first AI diagnostic agent grounded in real manufacturer manuals and parts data; 16 months in development with multiple clients; current "AI tools for trades" either hallucinate part numbers or aren't grounded in actual equipment data; photo → OEM manual section → part number → supplier link = confirmed product concept; HVAC-first recommended (largest volume, most standard manuals); sell through supply houses + ACCA trade associations; Sources: news.ycombinator.com/item?id=47509571 |
| 2026-08-17 | 82/105 | trends-2026-08-17 | Stable: SINGLE-source UNICORN VALIDATION of broader voice AI for trades — Avoca raised $125M at $1B valuation (April 2026); books $1B in jobs in 2026; AI answers phone after hours + qualifies leads + books into ServiceTitan; market shift: trade businesses paying $200/mo for software now pay $2,000/mo for AI-complete automation; white space for sub-$10M revenue trades who can't afford Avoca-tier onboarding; Spanish-first voice AI for Latino-owned trades (large underserved segment); industry-specific voice agents for niche trades (pool service, irrigation, pressure washing); "AI missed-call SMS follow-up" as standalone micro-product at $49-79/mo; AI dispatcher achieving 3.2x faster dispatch + 35% less drive time = $72K/year savings for mid-size FSM; after-hours AI answering = fastest-growing deployment pattern; FieldCamp 4 autonomous agents running 24/7 (Lead Triage, Customer Support, Follow-Up, Operations); Sources: finance.yahoo.com/sectors/technology/articles/avoca-raises-125m-1b-valuation-124500396.html, leapingai.com/blog/voice-ai-platforms-compared-leaping-ai-vs-avoca, bellafsm.com/ai-voice-agent-field-service, energent.ai/energent/compare/en/ai-powered-field-service-dispatch-software |
