...
| 2026-09-24 | 87/105 | trends-2026-09-24 | ↑5: STRONGEST-EVER VALIDATION — Avoca raised $125M at $1B valuation (April 2026 Series B led by Meritech/General Catalyst); 8-figure ARR; on track to book $1B in jobs in 2026. ServiceTitan 2026 State of AI survey (1,032 contractors): only 12% have AI embedded in ops, 34% experimenting = massive activation gap. HVAC contractors lose $45,600/yr from missed calls; plumbers up to $125,000/yr. Proliferating lower-end: Rosie/OnCrew at $49/mo = market going mainstream. KEY WHITE SPACE: (1) AI specifically for after-hours emergency triage and dispatch routing (not just booking); (2) AI voice integrated with maintenance agreement renewal calls; (3) voice agents that understand trade-specific terminology and equipment model numbers natively; (4) lightweight, no-setup-required AI receptionist priced for 1–2 truck operators who won't pay $300+/mo. 12% adoption with 34% experimenting = inflection point; window to build SMB entry is 12–18 months before Avoca/Breezy scale down. Sources: finance.yahoo.com/sectors/technology/articles/avoca-raises-125m-1b-valuation, fortune.com/2026/04/27/avoca-ai-agents-missed-calls-hvac-plumbing-roofing-kleiner-perkins, servicetitan.com/guides/2026-ai-in-the-trades |
